...
import (
	...
	todoapi "github.com/akm/goa_todo_example"
...
func main() {
	...
	{
		todosSvc = todoapi.NewTodos(logger)
	}

	// Wrap the services in endpoints that can be invoked from other services
	// potentially running in different processes.
	var (
		todosEndpoints *todos.Endpoints
	)
	{
		todosEndpoints = todos.NewEndpoints(todosSvc)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, todosEndpoints, &wg, errc, logger, *dbgF)
		}

		{
			...
			handleGRPCServer(ctx, u, todosEndpoints, &wg, errc, logger, *dbgF)
		}
