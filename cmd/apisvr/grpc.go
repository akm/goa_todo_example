...
import (
	...
	todossvr "github.com/akm/goa_todo_example/gen/grpc/todos/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, todosEndpoints *todos.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	todospb.RegisterTodosServer(srv, todosServer)
